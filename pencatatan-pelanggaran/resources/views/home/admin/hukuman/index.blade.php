        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-stats card-round">
                    <div class="card-body">
                        <a href="#" class="btn btn-primary mb-2 ml-3" data-toggle="modal"
                            data-target="#modalCreate"><i class="fa fa-plus mr-2"></i>Tambah Data</a>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" colspan="3">
                                                ...
                                                <a class="btn btn-link"
                                                    onclick="confirmDel('{{ route('hukuman.destroy', $h->id) }}')">
