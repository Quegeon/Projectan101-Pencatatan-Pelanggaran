    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-stats card-round">
                <div class="card-body">
                    <form id="submit-cenah" action="{{ route('review.update', $pelanggaran->id) }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="">Siswa</label>
                            <input type="text" name="" class="form-control" value="{{ $pelanggaran->Siswa->nama }}" readonly>
                        ...
                        <button type="submit" class="btn btn-primary {{ ($pelanggaran->Siswa->poin === 0) ? 'simphan' : '' }}">Simpan</button>
                    </form>
                </div>
            </div>
        </div>
