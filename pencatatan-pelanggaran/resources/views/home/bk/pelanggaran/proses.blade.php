    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-stats card-round">
                <div class="card-body">
                    <form action="{{ route('review.done', $pelanggaran->id) }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-xmark"></i> Kembali</button>
