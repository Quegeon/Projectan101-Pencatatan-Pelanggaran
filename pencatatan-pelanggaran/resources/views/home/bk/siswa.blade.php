                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                @switch($s->status)
                                                    @case('Baik')
                                                        <span
                                                            class="badge badge-success font-weight-bold">{{ $s->status }}</span>
                                                    @break
                                                    ...
                                                    @case('Buruk')
                                                        <span
                                                            class="badge badge-warning font-weight-bold">{{ $s->status }}</span>
                                                    @break
                                            ...
                                            <td align="center" colspan="3">
                                                <a href="{{ route('history', $s->nis) }}" class="btn btn-info"
                                                    data-toggle="tooltip" title="Detail"><i
                                                        class="fa fa-info-circle mr-1"></i>Detail</a>
                                            </td>
                                        </tr>
                                        <!-- Akhir modal -->
                                    @endforeach
