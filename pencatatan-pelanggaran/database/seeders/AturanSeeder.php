...
class AturanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $tampungan = [];
        $tampungan['hukuman'] = [
            'plbadsd' => Hukuman::where('hukuman', 'Peringatan lisan, Baca alquran dan shalat dhuha')->first()->id,
            'plbasddmlsddmpdjk' => Hukuman::where('hukuman', 'Peringatan lisan, Baca alquran shalat dhuha, dan membersihkan lingkungan sekolah dan diijinkan masuk pada jam kedua')->first()->id,
            'sp' => Hukuman::where('hukuman', 'Surat peringatan')->first()->id,
            'sppot' => Hukuman::where('hukuman', 'Surat peringatan, pemanggilan orang tua')->first()->id,
            'pl' => Hukuman::where('hukuman', 'Peringatan lisan')->first()->id,
            'plmam' => Hukuman::where('hukuman', 'Peringatan lisan, Mengisi absen manual')->first()->id,
            'plda' => Hukuman::where('hukuman', 'Peringatan lisan, Denda administrasi')->first()->id,
            'plmls' => Hukuman::where('hukuman', 'Peringatan lisan, Membersihkan lingkungan sekolah')->first()->id,
            'plbd' => Hukuman::where('hukuman', 'Peringatan lisan, baju dimasukan')->first()->id,
            'plsd' => Hukuman::where('hukuman', 'Peringatan lisan, sepatu di cat/di pilox')->first()->id,
            'plpb' => Hukuman::where('hukuman', 'Peringatan lisan, penyitaan barang')->first()->id,
            'pld' => Hukuman::where('hukuman', 'Peringatan lisan, dirobek / digunting')->first()->id,
            'plrd' => Hukuman::where('hukuman', 'Peringatan lisan, rambut dicukur')->first()->id,
            'pluw' => Hukuman::where('hukuman', 'Peringatan lisan, ubah/hapus warna')->first()->id,
            'plmc' => Hukuman::where('hukuman', 'Peringatan lisan, menghapus coretan')->first()->id,
            'sppotpb' => Hukuman::where('hukuman', 'Surat peringatan, Pemanggilan orang tua penyitaan barang')->first()->id,
            'sppots' => Hukuman::where('hukuman', 'Surat peringatan, pemanggilan orang tua skorsing')->first()->id,
            'pldrante' => Hukuman::where('hukuman', 'Peringatan lisan, digembos/dirante')->first()->id,
            'sppotdkot' => Hukuman::where('hukuman', 'Surat peringatan, Pemanggilan orang tua dikembalikan ke orang tua')->first()->id,
        ];

        $tampungan['jenis'] = [
            'keterlambatan' => Jenis::where('nama_jenis', 'Keterlambatan')->first()->id,
            'kepribadian' => Jenis::where('nama_jenis', 'Kepribadian')->first()->id,
            'kerajinan' => Jenis::where('nama_jenis', 'Kerajinan')->first()->id,
            'kerapihan' => Jenis::where('nama_jenis', 'Kerapihan')->first()->id,
            'ketertiban' => Jenis::where('nama_jenis', 'Ketertiban')->first()->id,
            'pelanggaran' => Jenis::where('nama_jenis', 'Pelanggaran terhadap Guru, Kepala Sekolah, Wakasek, Kepala Program dan Karyawan')->first()->id,
        ];
        ...
        Aturan::insert(
            [
                ...
                [
                    ...
                    'poin' => 10,
                    'id_hukuman' => $tampungan['hukuman']['plsd'],
                    'id_jenis' => $tampungan['jenis']['kerapihan'],
                ],
                [
                    'id' => Str::orderedUuid(),
        ...
        Aturan::insert(
            [
                ...
                [
                    ...
                    'poin' => 100,
                    'id_hukuman' => $tampungan['hukuman']['sppotdkot'],
                    'id_jenis' => $tampungan['jenis']['ketertiban'],
                ],
            ]
        );
